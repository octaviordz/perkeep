...
// `fuzeo`. The type in a list of mounted file systems will look like
// `fuzeo.foo`.
//
// FreeBSD ignores this option.
...
// /sys/fs/fuzeo/connections/CONN/max_background
...
//
// On Linux, this can be adjusted on the fly with
// /sys/fs/fuzeo/connections/CONN/congestion_threshold
